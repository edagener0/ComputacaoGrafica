...
class Example(Base):
    ...
    def initialize(self):
        ...
        self.translation3 = Uniform('vec3', [0.0, 0.5, 0.0])
        self.translation3.locate_variable(self.program_ref, 'translation')
        self.translation4 = Uniform('vec3', [0.0, -0.5, 0.0])
        ...
        self.base_color3 = Uniform('vec3', [0.0, 1.0, 0.0])
        self.base_color3.locate_variable(self.program_ref, 'baseColor')
        self.base_color4 = Uniform('vec3', [1.0, 1.0, 0.0])
