...
class Example(Base):
    ...
    def initialize(self):
        ...
        directional_light = DirectionalLight(color=[10.0, 5.0, 6.0], direction=[-1, -1, -2])
    ...
    def update(self):
        ...
        z = radius * math.cos(self.angle)

        self.rig.set_position([x, 0, z])

        # fazer a câmara olhar para o centro (0,0,0)
